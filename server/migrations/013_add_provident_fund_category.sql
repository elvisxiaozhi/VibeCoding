...
SELECT id, symbol, category, cost_basis, current_price, quantity, currency, created_at, updated_at, user_id, purchased_at, market, dividends, owner, note FROM assets WHERE category IN ('stock', 'etf', 'gold', 'crypto', 'cash', 'currency');
